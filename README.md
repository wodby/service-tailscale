# Tailscale service for Wodby

Use Tailscale as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public Tailscale service in the Wodby catalog.

- [Tailscale service in the Wodby catalog](https://wodby.com/services/tailscale)
...
4. Reference `tailscale` from your stack manifest.
